...
inline namespace hcomp{
    inline bigcomplex from_polar(bigreal r, bigreal theta){
        bigreal sin_th;
        bigreal cos_th;
        big_cordic::calc_sincos(theta, sin_th, cos_th);
    ...
    inline bigcomplex polar_coords(bigcomplex __z){
        bigreal _theta, _hyp;
        big_cordic::calc_arctan(__z.imaginary_part/__z.real_part, _theta, _hyp);
    ...
    inline bigcomplex real_pow(bigcomplex __z, bigreal __e){
        ...
        bigreal __expabs = big_cordic::pow(__abs, __e);
